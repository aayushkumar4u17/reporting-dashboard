/**
 * Authentication utility functions for checking login state and cache management
 */
 ...
 */
export const setReportingLoginState = () => {
...
/**
 * Check if user can access reporting dashboard
 */
export const canAccessReportingDashboard = () => {
	try {
